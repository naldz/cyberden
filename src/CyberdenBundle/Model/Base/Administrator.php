...
abstract class Administrator implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CyberdenBundle\\Model\\Map\\AdministratorTableMap';
    ...
    /**
     * Initializes internal state of CyberdenBundle\Model\Base\Administrator object.
     */
     ...
     * @return $this|\CyberdenBundle\Model\Administrator The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[AdministratorTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AdministratorTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CyberdenBundle\\Model\\Administrator'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdministratorTableMap::COL_NAME)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CyberdenBundle\Model\Administrator
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CyberdenBundle\Model\Administrator The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdministratorTableMap::COL_NAME)) {
            $criteria->add(AdministratorTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(AdministratorTableMap::COL_USERNAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CyberdenBundle\Model\Administrator (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CyberdenBundle\Model\Administrator Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAdministrator is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAdministrator The current object (for fluent API support)
     */
    public function setSessions(Collection $sessions, ConnectionInterface $con = null)
    {
        ...
        foreach ($sessionsToDelete as $sessionRemoved) {
            $sessionRemoved->setAdministrator(null);
        }
     ...
     * Otherwise if this Administrator is new, it will return
     * an empty collection; or if this Administrator has previously
     * been saved, it will retrieve related Sessions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Administrator.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildSession[] List of ChildSession objects
     */
    public function getSessionsJoinStation(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSessionQuery::create(null, $criteria);
