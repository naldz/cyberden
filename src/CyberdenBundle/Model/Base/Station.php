...
abstract class Station implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CyberdenBundle\\Model\\Map\\StationTableMap';
    ...
    /**
     * The value for the is_commissioned field.
     *
     * @var        int
     */
    protected $is_commissioned;
    ...
    /**
     * Initializes internal state of CyberdenBundle\Model\Base\Station object.
     */
    ...
    /**
     * Get the [is_commissioned] column value.
     *
     * @return int
     */
    ...
    public function setMacAddress($v)
    {
        ...
        if ($this->mac_address !== $v) {
            $this->mac_address = $v;
            $this->modifiedColumns[StationTableMap::COL_MAC_ADDRESS] = true;
        }
    ...
    /**
     * Set the value of [is_commissioned] column.
     *
     * @param int $v new value
     * @return $this|\CyberdenBundle\Model\Station The current object (for fluent API support)
     */
    public function setIsCommissioned($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->is_commissioned !== $v) {
            $this->is_commissioned = $v;
            $this->modifiedColumns[StationTableMap::COL_IS_COMMISSIONED] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StationTableMap::translateFieldName('MacAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mac_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StationTableMap::translateFieldName('IsCommissioned', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_commissioned = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CyberdenBundle\\Model\\Station'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->sessionsScheduledForDeletion !== null) {
                if (!$this->sessionsScheduledForDeletion->isEmpty()) {
                    \CyberdenBundle\Model\SessionQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StationTableMap::COL_MAC_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'mac_address';
        }
        if ($this->isColumnModified(StationTableMap::COL_IS_COMMISSIONED)) {
            $modifiedColumns[':p' . $index++]  = 'is_commissioned';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'mac_address':
                        ...
                        break;
                    case 'is_commissioned':
                        $stmt->bindValue($identifier, $this->is_commissioned, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getMacAddress(),
            $keys[3] => $this->getIsCommissioned(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CyberdenBundle\Model\Station
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setMacAddress($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIsCommissioned($arr[$keys[3]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CyberdenBundle\Model\Station The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StationTableMap::COL_MAC_ADDRESS)) {
            $criteria->add(StationTableMap::COL_MAC_ADDRESS, $this->mac_address);
        }
        if ($this->isColumnModified(StationTableMap::COL_IS_COMMISSIONED)) {
            $criteria->add(StationTableMap::COL_IS_COMMISSIONED, $this->is_commissioned);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CyberdenBundle\Model\Station (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsCommissioned($this->getIsCommissioned());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CyberdenBundle\Model\Station Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSessions($overrideExisting = true)
    {
        ...
        $this->collSessions->setModel('\CyberdenBundle\Model\Session');
    }
    ...
    public function setSessions(Collection $sessions, ConnectionInterface $con = null)
    {
        ...
        foreach ($sessionsToDelete as $sessionRemoved) {
            $sessionRemoved->setStation(null);
        }
     ...
     * @return ObjectCollection|ChildSession[] List of ChildSession objects
     */
    public function getSessionsJoinAdministrator(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildSessionQuery::create(null, $criteria);
        $query->joinWith('Administrator', $joinBehavior);
