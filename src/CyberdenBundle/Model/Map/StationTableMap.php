...
use CyberdenBundle\Model\Station;
...
class StationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.CyberdenBundle.Model.Map.StationTableMap';
     ...
     */
    const OM_CLASS = '\\CyberdenBundle\\Model\\Station';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.CyberdenBundle.Model.Station';
     ...
     */
    const COL_MAC_ADDRESS = 'station.mac_address';

    /**
     * the column name for the is_commissioned field
     */
    const COL_IS_COMMISSIONED = 'station.is_commissioned';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'MacAddress', 'IsCommissioned', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'macAddress', 'isCommissioned', ),
        self::TYPE_COLNAME       => array(StationTableMap::COL_ID, StationTableMap::COL_NAME, StationTableMap::COL_MAC_ADDRESS, StationTableMap::COL_IS_COMMISSIONED, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'mac_address', 'is_commissioned', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'MacAddress' => 2, 'IsCommissioned' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'macAddress' => 2, 'isCommissioned' => 3, ),
        self::TYPE_COLNAME       => array(StationTableMap::COL_ID => 0, StationTableMap::COL_NAME => 1, StationTableMap::COL_MAC_ADDRESS => 2, StationTableMap::COL_IS_COMMISSIONED => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'mac_address' => 2, 'is_commissioned' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CyberdenBundle\\Model\\Station');
        ...
        $this->addColumn('mac_address', 'MacAddress', 'VARCHAR', true, 20, null);
        $this->addColumn('is_commissioned', 'IsCommissioned', 'TINYINT', true, 3, null);
    } // initialize()
    ...
    {
        $this->addRelation('Session', '\\CyberdenBundle\\Model\\Session', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':station_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StationTableMap::COL_MAC_ADDRESS);
            $criteria->addSelectColumn(StationTableMap::COL_IS_COMMISSIONED);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.mac_address');
            $criteria->addSelectColumn($alias . '.is_commissioned');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CyberdenBundle\Model\Station) { // it's a model object
