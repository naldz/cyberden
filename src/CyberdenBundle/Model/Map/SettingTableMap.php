...
use CyberdenBundle\Model\Setting;
...
class SettingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.CyberdenBundle.Model.Map.SettingTableMap';
     ...
     */
    const OM_CLASS = '\\CyberdenBundle\\Model\\Setting';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.CyberdenBundle.Model.Setting';
    ...
    /**
     * the column name for the rental_price field
     */
    const COL_RENTAL_PRICE = 'setting.rental_price';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'RentalPrice', ),
        self::TYPE_CAMELNAME     => array('id', 'rentalPrice', ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_ID, SettingTableMap::COL_RENTAL_PRICE, ),
        self::TYPE_FIELDNAME     => array('id', 'rental_price', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'RentalPrice' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'rentalPrice' => 1, ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_ID => 0, SettingTableMap::COL_RENTAL_PRICE => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'rental_price' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CyberdenBundle\\Model\\Setting');
        $this->setPackage('src.CyberdenBundle.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'SMALLINT', true, 5, null);
        $this->addColumn('rental_price', 'RentalPrice', 'SMALLINT', true, 5, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingTableMap::COL_RENTAL_PRICE);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.rental_price');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CyberdenBundle\Model\Setting) { // it's a model object
