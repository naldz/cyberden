...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'db_patcher.database_patcher' => 'getDbPatcher_DatabasePatcherService',
            'db_patcher.driver_configurator' => 'getDbPatcher_DriverConfiguratorService',
            'db_patcher.mysql_dsn_parser' => 'getDbPatcher_MysqlDsnParserService',
            'db_patcher.mysql_patcher_driver' => 'getDbPatcher_MysqlPatcherDriverService',
            'db_patcher.patch_registry' => 'getDbPatcher_PatchRegistryService',
            'db_patcher.patch_repository' => 'getDbPatcher_PatchRepositoryService',
            'db_patcher.sqlite_dsn_parser' => 'getDbPatcher_SqliteDsnParserService',
            'db_patcher.sqlite_patcher_driver' => 'getDbPatcher_SqlitePatcherDriverService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WBTJmLMngh', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8KiAMF7KMq', 0, 'JDRJh9WiU95vHoeM8j6ye4', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cyberden.entity_repository.administrator'] = new \CyberdenBundle\Service\EntityRepository\AdministratorRepository($this->get('event_dispatcher'));
    }

    /*
     * Gets the 'cyberden.security_user_provider.administrator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CyberdenBundle\Service\Security\UserProvider\AdministratorUserProvider A CyberdenBundle\Service\Security\UserProvider\AdministratorUserProvider instance
     */
    ...
    /*
     * Gets the 'db_patcher.database_patcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\DatabasePatcher A Naldz\Bundle\DBPatcherBundle\Patcher\DatabasePatcher instance
     */
    protected function getDbPatcher_DatabasePatcherService()
    {
        $this->services['db_patcher.database_patcher'] = $instance = new \Naldz\Bundle\DBPatcherBundle\Patcher\DatabasePatcher(($this->targetDirs[3].'/app/../dbpatch'));

        $this->get('db_patcher.driver_configurator')->configure($instance);

        return $instance;
    }

    /*
     * Gets the 'db_patcher.driver_configurator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\DriverConfigurator A Naldz\Bundle\DBPatcherBundle\Patcher\DriverConfigurator instance
     */
    protected function getDbPatcher_DriverConfiguratorService()
    {
        return $this->services['db_patcher.driver_configurator'] = new \Naldz\Bundle\DBPatcherBundle\Patcher\DriverConfigurator('mysql:root:password@localhost\\cyberden', array('mysql' => $this->get('db_patcher.mysql_patcher_driver'), 'sqlite' => $this->get('db_patcher.sqlite_patcher_driver')));
    }

    /*
     * Gets the 'db_patcher.mysql_dsn_parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\DsnParser\MysqlDsnParser A Naldz\Bundle\DBPatcherBundle\Patcher\DsnParser\MysqlDsnParser instance
     */
    protected function getDbPatcher_MysqlDsnParserService()
    {
        return $this->services['db_patcher.mysql_dsn_parser'] = new \Naldz\Bundle\DBPatcherBundle\Patcher\DsnParser\MysqlDsnParser();
    }

    /*
     * Gets the 'db_patcher.mysql_patcher_driver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\Driver\MysqlDriver A Naldz\Bundle\DBPatcherBundle\Patcher\Driver\MysqlDriver instance
     */
    protected function getDbPatcher_MysqlPatcherDriverService()
    {
        return $this->services['db_patcher.mysql_patcher_driver'] = new \Naldz\Bundle\DBPatcherBundle\Patcher\Driver\MysqlDriver($this->get('db_patcher.mysql_dsn_parser'), 'mysql:root:password@localhost\\cyberden', '/usr/local/mysql/bin/mysql');
    }

    /*
     * Gets the 'db_patcher.patch_registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\PatchRegistry A Naldz\Bundle\DBPatcherBundle\Patcher\PatchRegistry instance
     */
    protected function getDbPatcher_PatchRegistryService()
    {
        $this->services['db_patcher.patch_registry'] = $instance = new \Naldz\Bundle\DBPatcherBundle\Patcher\PatchRegistry(($this->targetDirs[3].'/app/../dbpatch'));
    ...
    /*
     * Gets the 'db_patcher.patch_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\PatchRepository A Naldz\Bundle\DBPatcherBundle\Patcher\PatchRepository instance
     */
    protected function getDbPatcher_PatchRepositoryService()
    {
        return $this->services['db_patcher.patch_repository'] = new \Naldz\Bundle\DBPatcherBundle\Patcher\PatchRepository(($this->targetDirs[3].'/app/../dbpatch'), $this->get('db_patcher.patch_registry'));
    }

    /*
     * Gets the 'db_patcher.sqlite_dsn_parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\DsnParser\SqliteDsnParser A Naldz\Bundle\DBPatcherBundle\Patcher\DsnParser\SqliteDsnParser instance
     */
    protected function getDbPatcher_SqliteDsnParserService()
    {
        return $this->services['db_patcher.sqlite_dsn_parser'] = new \Naldz\Bundle\DBPatcherBundle\Patcher\DsnParser\SqliteDsnParser();
    }

    /*
     * Gets the 'db_patcher.sqlite_patcher_driver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Naldz\Bundle\DBPatcherBundle\Patcher\Driver\SqliteDriver A Naldz\Bundle\DBPatcherBundle\Patcher\Driver\SqliteDriver instance
     */
    protected function getDbPatcher_SqlitePatcherDriverService()
    {
        return $this->services['db_patcher.sqlite_patcher_driver'] = new \Naldz\Bundle\DBPatcherBundle\Patcher\Driver\SqliteDriver($this->get('db_patcher.sqlite_dsn_parser'), 'mysql:root:password@localhost\\cyberden', '/usr/local/mysql/bin/mysql');
    }
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => 'form.type.form', 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType' => 'form.type.choice', 'Propel\\Bundle\\PropelBundle\\Form\\Type\\ModelType' => 'propel.form.type.model'), array('Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.csrf', 2 => 'form.type_extension.upload.validator', 3 => 'form.type_extension.form.validator'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\SubmitType' => array(0 => 'form.type_extension.submit.validator'), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\RepeatedType' => array(0 => 'form.type_extension.repeated.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.propel'))), $this->get('form.resolved_type_factory'));
    }
    ...
    {
        return $this->services['propel.dumper.yaml'] = new \Propel\Bundle\PropelBundle\DataFixtures\Dumper\YamlDataDumper(($this->targetDirs[3].'/app'), array('database' => array('connections' => array('cyberden' => array('adapter' => 'mysql', 'user' => 'root', 'password' => 'password', 'dsn' => 'mysql:host=localhost;dbname=cyberden;charset=UTF8', 'attributes' => array('ATTR_EMULATE_PREPARES' => false), 'classname' => '\\Propel\\Runtime\\Connection\\ConnectionWrapper', 'options' => array('ATTR_PERSISTENT' => false), 'model_paths' => array(0 => 'src', 1 => 'vendor'), 'slaves' => array())), 'adapters' => array('mysql' => array('tableType' => 'InnoDB', 'tableEngineKeyword' => 'ENGINE'), 'sqlite' => array(), 'oracle' => array('autoincrementSequencePattern' => '${table}_SEQ'))), 'general' => array('project' => '', 'version' => '2.0.0-dev'), 'exclude_tables' => array(), 'paths' => array('projectDir' => $this->targetDirs[3], 'schemaDir' => $this->targetDirs[3], 'outputDir' => $this->targetDirs[3], 'phpDir' => ($this->targetDirs[3].'/generated-classes'), 'phpConfDir' => ($this->targetDirs[3].'/generated-conf'), 'sqlDir' => ($this->targetDirs[3].'/generated-sql'), 'migrationDir' => ($this->targetDirs[3].'/generated-migrations'), 'composerDir' => NULL), 'migrations' => array('samePhpName' => false, 'addVendorInfo' => false, 'tableName' => 'propel_migration', 'parserClass' => NULL), 'runtime' => array('connections' => array(), 'logging' => false, 'log' => array(), 'defaultConnection' => 'cyberden'), 'generator' => array('platformClass' => NULL, 'packageObjectModel' => true, 'namespaceAutoPackage' => true, 'recursive' => false, 'connections' => array(), 'schema' => array('basename' => 'schema', 'autoPrefix' => false, 'autoPackage' => false, 'autoNamespace' => false, 'transform' => false), 'dateTime' => array('useDateTimeClass' => true, 'dateTimeClass' => 'DateTime'), 'objectModel' => array('addGenericAccessors' => true, 'addGenericMutators' => true, 'emulateForeignKeyConstraints' => false, 'addClassLevelComment' => true, 'defaultKeyType' => 'phpName', 'addSaveMethod' => true, 'namespaceMap' => 'Map', 'addTimeStamp' => false, 'addHooks' => true, 'classPrefix' => NULL, 'useLeftJoinsInDoJoinMethods' => true, 'pluralizerClass' => '\\Propel\\Common\\Pluralizer\\StandardEnglishPluralizer', 'entityNotFoundExceptionClass' => '\\Propel\\Runtime\\Exception\\EntityNotFoundException', 'builders' => array('object' => '\\Propel\\Generator\\Builder\\Om\\ObjectBuilder', 'objectstub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionObjectBuilder', 'objectmultiextend' => '\\Propel\\Generator\\Builder\\Om\\MultiExtendObjectBuilder', 'query' => '\\Propel\\Generator\\Builder\\Om\\QueryBuilder', 'querystub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionQueryBuilder', 'queryinheritance' => '\\Propel\\Generator\\Builder\\Om\\QueryInheritanceBuilder', 'queryinheritancestub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionQueryInheritanceBuilder', 'tablemap' => '\\Propel\\Generator\\Builder\\Om\\TableMapBuilder', 'interface' => '\\Propel\\Generator\\Builder\\Om\\InterfaceBuilder')), 'defaultConnection' => 'cyberden')));
    }
    ...
    {
        return $this->services['propel.loader.xml'] = new \Propel\Bundle\PropelBundle\DataFixtures\Loader\XmlDataLoader(($this->targetDirs[3].'/app'), array('database' => array('connections' => array('cyberden' => array('adapter' => 'mysql', 'user' => 'root', 'password' => 'password', 'dsn' => 'mysql:host=localhost;dbname=cyberden;charset=UTF8', 'attributes' => array('ATTR_EMULATE_PREPARES' => false), 'classname' => '\\Propel\\Runtime\\Connection\\ConnectionWrapper', 'options' => array('ATTR_PERSISTENT' => false), 'model_paths' => array(0 => 'src', 1 => 'vendor'), 'slaves' => array())), 'adapters' => array('mysql' => array('tableType' => 'InnoDB', 'tableEngineKeyword' => 'ENGINE'), 'sqlite' => array(), 'oracle' => array('autoincrementSequencePattern' => '${table}_SEQ'))), 'general' => array('project' => '', 'version' => '2.0.0-dev'), 'exclude_tables' => array(), 'paths' => array('projectDir' => $this->targetDirs[3], 'schemaDir' => $this->targetDirs[3], 'outputDir' => $this->targetDirs[3], 'phpDir' => ($this->targetDirs[3].'/generated-classes'), 'phpConfDir' => ($this->targetDirs[3].'/generated-conf'), 'sqlDir' => ($this->targetDirs[3].'/generated-sql'), 'migrationDir' => ($this->targetDirs[3].'/generated-migrations'), 'composerDir' => NULL), 'migrations' => array('samePhpName' => false, 'addVendorInfo' => false, 'tableName' => 'propel_migration', 'parserClass' => NULL), 'runtime' => array('connections' => array(), 'logging' => false, 'log' => array(), 'defaultConnection' => 'cyberden'), 'generator' => array('platformClass' => NULL, 'packageObjectModel' => true, 'namespaceAutoPackage' => true, 'recursive' => false, 'connections' => array(), 'schema' => array('basename' => 'schema', 'autoPrefix' => false, 'autoPackage' => false, 'autoNamespace' => false, 'transform' => false), 'dateTime' => array('useDateTimeClass' => true, 'dateTimeClass' => 'DateTime'), 'objectModel' => array('addGenericAccessors' => true, 'addGenericMutators' => true, 'emulateForeignKeyConstraints' => false, 'addClassLevelComment' => true, 'defaultKeyType' => 'phpName', 'addSaveMethod' => true, 'namespaceMap' => 'Map', 'addTimeStamp' => false, 'addHooks' => true, 'classPrefix' => NULL, 'useLeftJoinsInDoJoinMethods' => true, 'pluralizerClass' => '\\Propel\\Common\\Pluralizer\\StandardEnglishPluralizer', 'entityNotFoundExceptionClass' => '\\Propel\\Runtime\\Exception\\EntityNotFoundException', 'builders' => array('object' => '\\Propel\\Generator\\Builder\\Om\\ObjectBuilder', 'objectstub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionObjectBuilder', 'objectmultiextend' => '\\Propel\\Generator\\Builder\\Om\\MultiExtendObjectBuilder', 'query' => '\\Propel\\Generator\\Builder\\Om\\QueryBuilder', 'querystub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionQueryBuilder', 'queryinheritance' => '\\Propel\\Generator\\Builder\\Om\\QueryInheritanceBuilder', 'queryinheritancestub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionQueryInheritanceBuilder', 'tablemap' => '\\Propel\\Generator\\Builder\\Om\\TableMapBuilder', 'interface' => '\\Propel\\Generator\\Builder\\Om\\InterfaceBuilder')), 'defaultConnection' => 'cyberden')));
    }
    ...
    {
        return $this->services['propel.loader.yaml'] = new \Propel\Bundle\PropelBundle\DataFixtures\Loader\YamlDataLoader(($this->targetDirs[3].'/app'), array('database' => array('connections' => array('cyberden' => array('adapter' => 'mysql', 'user' => 'root', 'password' => 'password', 'dsn' => 'mysql:host=localhost;dbname=cyberden;charset=UTF8', 'attributes' => array('ATTR_EMULATE_PREPARES' => false), 'classname' => '\\Propel\\Runtime\\Connection\\ConnectionWrapper', 'options' => array('ATTR_PERSISTENT' => false), 'model_paths' => array(0 => 'src', 1 => 'vendor'), 'slaves' => array())), 'adapters' => array('mysql' => array('tableType' => 'InnoDB', 'tableEngineKeyword' => 'ENGINE'), 'sqlite' => array(), 'oracle' => array('autoincrementSequencePattern' => '${table}_SEQ'))), 'general' => array('project' => '', 'version' => '2.0.0-dev'), 'exclude_tables' => array(), 'paths' => array('projectDir' => $this->targetDirs[3], 'schemaDir' => $this->targetDirs[3], 'outputDir' => $this->targetDirs[3], 'phpDir' => ($this->targetDirs[3].'/generated-classes'), 'phpConfDir' => ($this->targetDirs[3].'/generated-conf'), 'sqlDir' => ($this->targetDirs[3].'/generated-sql'), 'migrationDir' => ($this->targetDirs[3].'/generated-migrations'), 'composerDir' => NULL), 'migrations' => array('samePhpName' => false, 'addVendorInfo' => false, 'tableName' => 'propel_migration', 'parserClass' => NULL), 'runtime' => array('connections' => array(), 'logging' => false, 'log' => array(), 'defaultConnection' => 'cyberden'), 'generator' => array('platformClass' => NULL, 'packageObjectModel' => true, 'namespaceAutoPackage' => true, 'recursive' => false, 'connections' => array(), 'schema' => array('basename' => 'schema', 'autoPrefix' => false, 'autoPackage' => false, 'autoNamespace' => false, 'transform' => false), 'dateTime' => array('useDateTimeClass' => true, 'dateTimeClass' => 'DateTime'), 'objectModel' => array('addGenericAccessors' => true, 'addGenericMutators' => true, 'emulateForeignKeyConstraints' => false, 'addClassLevelComment' => true, 'defaultKeyType' => 'phpName', 'addSaveMethod' => true, 'namespaceMap' => 'Map', 'addTimeStamp' => false, 'addHooks' => true, 'classPrefix' => NULL, 'useLeftJoinsInDoJoinMethods' => true, 'pluralizerClass' => '\\Propel\\Common\\Pluralizer\\StandardEnglishPluralizer', 'entityNotFoundExceptionClass' => '\\Propel\\Runtime\\Exception\\EntityNotFoundException', 'builders' => array('object' => '\\Propel\\Generator\\Builder\\Om\\ObjectBuilder', 'objectstub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionObjectBuilder', 'objectmultiextend' => '\\Propel\\Generator\\Builder\\Om\\MultiExtendObjectBuilder', 'query' => '\\Propel\\Generator\\Builder\\Om\\QueryBuilder', 'querystub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionQueryBuilder', 'queryinheritance' => '\\Propel\\Generator\\Builder\\Om\\QueryInheritanceBuilder', 'queryinheritancestub' => '\\Propel\\Generator\\Builder\\Om\\ExtensionQueryInheritanceBuilder', 'tablemap' => '\\Propel\\Generator\\Builder\\Om\\TableMapBuilder', 'interface' => '\\Propel\\Generator\\Builder\\Om\\InterfaceBuilder')), 'defaultConnection' => 'cyberden')), NULL);
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('sxnZcGAd7w', NULL, 'JDRJh9WiU95vHoeM8j6ye4', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('CyberdenBundle\\Model\\Administrator' => array('algorithm' => 'sha256', 'encode_as_base64' => false, 'iterations' => 1, 'hash_algorithm' => 'sha512', 'key_length' => 40, 'ignore_case' => false, 'cost' => 13)));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CyberdenBundle/Resources/views'), 'Cyberden');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GgDHWTI5s8', 0, 'JDRJh9WiU95vHoeM8j6ye4', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VX19+IbeIt', 0, 'JDRJh9WiU95vHoeM8j6ye4', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private $loadedDynamicParameters = array(
        ...
        'db_patcher.patch_dir' => false,
        'propel.configuration' => false,
    );
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'db_patcher.patch_dir': $value = ($this->targetDirs[3].'/app/../dbpatch'); break;
            case 'propel.configuration': $value = array(
                'database' => array(
                    'connections' => array(
                        'cyberden' => array(
                            'adapter' => 'mysql',
                            'user' => 'root',
                            'password' => 'password',
                            'dsn' => 'mysql:host=localhost;dbname=cyberden;charset=UTF8',
                            'attributes' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DBPatcherBundle' => 'Naldz\\Bundle\\DBPatcherBundle\\DBPatcherBundle',
                'PropelBundle' => 'Propel\\Bundle\\PropelBundle\\PropelBundle',
                'CyberdenBundle' => 'CyberdenBundle\\CyberdenBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'cyberden',
            'database_user' => 'root',
            ...
            'driver_client_path' => '/usr/local/mysql/bin/mysql',
            'locale' => 'en',
            ...
            'db_patcher.dsn' => 'mysql:root:password@localhost\\cyberden',
            'db_patcher.driver_client_path' => '/usr/local/mysql/bin/mysql',
